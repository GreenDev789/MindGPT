...
from mindgpt.abstract import AbstractMixin, AbstractChain
from mindgpt.condition import ConditionMixin, ConditionChain
from mindgpt.infer import InferMixin, InferChain
from mindgpt.memory import MemoryMixin, ExecuteWithContextChain
from mindgpt.refine import RefineMixin, RefineChain
from mindgpt.gpt_select import SelectChain, SelectMixin

from mindgpt.summarize import SummarizeMixin, SummarizeChain



class MindGPT(ChatOpenAI, MemoryMixin, AbstractMixin, RefineMixin, ConditionMixin, SelectMixin, InferMixin, SummarizeMixin, extra=Extra.allow):
